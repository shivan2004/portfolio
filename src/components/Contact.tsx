            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:shivansamala@gmail.com" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                      shivansamala@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Warangal, Telangana, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.linkedin.com/in/shivansamala" className="bg-gray-100 p-3 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 group">
                    <Linkedin size={20} className="group-hover:scale-110 transition-transform duration-300" />
                  </a>
                  <a href="https://github.com/shivan2004" className="bg-gray-100 p-3 rounded-lg hover:bg-gray-800 hover:text-white transition-all duration-300 group">
                    <Github size={20} className="group-hover:scale-110 transition-transform duration-300" />
                  </a>
                  <a href="https://x.com/shivan_samala" className="bg-gray-100 p-3 rounded-lg hover:bg-blue-400 hover:text-white transition-all duration-300 group">
                    <Twitter size={20} className="group-hover:scale-110 transition-transform duration-300" />
                  </a>
                  <a href="https://www.instagram.com/shivan_samala" className="bg-gray-100 p-3 rounded-lg hover:bg-pink-500 hover:text-white transition-all duration-300 group">
