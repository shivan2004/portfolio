          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Passionate full-stack developer and final year student, dedicated to creating 
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-4">
                <a 
                  href="https://linkedin.com/in/shivan-samala" 
                  target="_blank" 
                ...
                <a 
                  href="https://github.com/shivan-samala" 
                  target="_blank" 
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://twitter.com/shivan_samala" 
                  target="_blank" 
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://instagram.com/shivan_samala" 
                  target="_blank" 
                  rel="noopener noreferrer"
                ...
                <a 
                  href="mailto:shivansamala@gmail.com"
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm mb-4 md:mb-0">
                © {currentYear} Shivan Samala. All rights reserved.
              </p>
